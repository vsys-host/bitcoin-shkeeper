...
class TestBlocks(unittest.TestCase, CustomAssertions):
    ...
    def test_blocks_parse_block_and_transactions(self):
        ...
        try:
            ...
            self.skipTest('Block object has no attribute check_proof_of_work')
    ...
    def test_blocks_parse_block_and_transactions_2(self):
        ...
        try:
            ...
            self.skipTest('Block object has no attribute version_bin')
    ...
    def test_block_parse_transaction_dict(self):
        ...
        try:
            ...
            self.skipTest('Block object has no attribute parse_transactions_dict')
