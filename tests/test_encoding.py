...
from app.lib.config.opcodes import op
from app.lib.encoding import *
from app.lib.encoding import _bech32_polymod, _codestring_to_array
...
BECH32M_INVALID = [
    ...
    ('BC1S0XLXVLHEMJA6C4DQV22UAPCTQUPFHLXM9H8Z3K2E72Q4K9HCZ7VQ7ZWS8R', 'Invalid witness version'),
