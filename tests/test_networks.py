...
class TestNetworks(unittest.TestCase):
    ...
    def test_networks_prefix_wif_network_by_value(self):
        self.assertEqual(network_by_value('prefix_wif', '80')[:1], ['main'])
    ...
    def test_network_defined(self):
        self.assertTrue(network_defined('main'))
    ...
    def test_wif_prefix_search(self):
        exp_dict = {
            ...
            'script_type': 'p2pkh',
            'witness_type': 'legacy'}
        self.assertEqual(wif_prefix_search('0488ADE4', network='main')[0], exp_dict)
        self.assertEqual(wif_prefix_search('lettrythisstrangestring', network='main'), [])

    def test_network_dunders(self):
        n1 = Network('main')
        self.assertTrue(n1 == 'main')
        self.assertTrue(n1 != 'dogecoin')
        self.assertEqual(str(n1), "<Network: main>")
