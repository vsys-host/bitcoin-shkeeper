...
class AmlCryptoConfig(BaseModel):
    ...
    @classmethod
    def validate_scores(cls, value: Dict[str, AmlRiskConfig]) -> Dict[str, AmlRiskConfig]:
        ...
        if int_start != 0 or int_end != 1:
            raise ValueError(f"risk scores should cover interval [0; 1], got [{int_start}; {int_end}]")
